...
export const multipleNonRandomRecipesUrl = `${baseUrl}?type=public&app_id=${APP_ID}&app_key=${APP_KEY}&field=label&field=image&field=calories&field=cuisineType&field=dietLabels&field=source&field=url&field=totalTime&field=uri&field=yield&field=ingredients`;
